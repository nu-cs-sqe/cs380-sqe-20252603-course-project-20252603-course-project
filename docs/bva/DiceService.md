...
| T3_multiRoll2Rolls | multiRollDice is called with a roll count of 3.                             | An integer array of length 3 is returned with expected values.                     | :white_check_mark:                                             |
...
| T5_multiRollSingleRoll | multiRollDice is called with a roll count of 1.                                                                                                                 | An integer array of length 1 is returned with expected values. | :white_check_mark:   |
