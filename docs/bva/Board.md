...
|-------------|-------------------|-----------------|--------------|
| Test Case 1 | `new Board()` | creates non-null board instance | :x:          |
| Test Case 2 | board initialization | snapshot dimensions are `8 x 8` | :x:          |
| Test Case 3 | board initialization | black pawns exist at row `1`, cols `0..7` | :x:          |
...
| Test Case 8 | board initialization | white knights exist at `(7,1)` and `(7,6)` | :x:          |
| Test Case 9 | board initialization | black bishops exist at `(0,2)` and `(0,5)` | :x:          |
| Test Case 10 | board initialization | white bishops exist at `(7,2)` and `(7,5)` | :x:          |
