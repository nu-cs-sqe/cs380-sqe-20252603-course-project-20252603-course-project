...
|---|------------------------------------------------------------------------------------------------------|:------:|----------------|----------------------------------|
| 0 | The team has closed and merged the past Feedback PR(s), indicating that they have read the feedback. | ✅ | Past feedback PRs have been merged. | See team's weekly reports and PR history |

### Software Process Quality
| # | Item                                                                                                                                         | Status | Reviewer Notes | Source Instructions or Resources                                                                              |
|---|----------------------------------------------------------------------------------------------------------------------------------------------|:------:|----------------|---------------------------------------------------------------------------------------------------------------|
| 1 | Checkstyle: Checkstyle is set up or there is a to-do item planned in the Project Management board for this task. (needed for Letter Grade B) | ⚠️ | Not configured yet; add to board. | Week 6 Monday lecture (Lecture 11); the build script and config file in the repository for Lab: Code Coverage |
| 2 | SpotBugs: SpotBugs is set up or there is a to-do item planned in the Project Management board for this task. (needed for Letter Grade B)     | ⚠️ | Not configured yet; add to board. | Week 6 Monday lecture (Lecture 11); the build script and config file in the repository for Lab: Code Coverage |

### Planning & Progress Evaluation
| # | Item                                                                                                                                                         |  Status   | Reviewer Notes      | Source Instructions or Resources                                                  |
|---|--------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|---------------------|-----------------------------------------------------------------------------------|
| 4 | The team documents every week’s planning and progress evaluation professionally. (needed for Letter Grade B)                                                 | ✅ | Weekly reports present and contain status and PR links for recent work. | Week 4 Wednesday Lecture (Lecture 08), Project grading rubrics                    |

### Progress & Collaboration
| # | Item                                                                                                                                                                                   |  Status   | Reviewer Notes      | Source Instructions or Resources                 |
|---|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|---------------------|--------------------------------------------------|
| 5 | Overall development progress (recall the recommended order is: Game Setup Phase -> One turn of the game -> Multiple turns -> One win condition -> Other win conditions (if applicable) | ⚠️ | Core model classes implemented (Card, Deck, Player). Game class and integration tests still pending. | Canvas assignment Project: Week 4 and 5 Guidance |
...
## Additional Comments
Great progress this week overall. The core domain classes are starting to take shape, which is a solid step forward. The next priority should be connecting these pieces into a working Game class so that the system can actually execute a full turn flow end to end.

For tooling, make sure Checkstyle and SpotBugs are added soon, either configured in the build or clearly tracked as active tasks on the board. This will help avoid last minute setup pressure and keep the code quality pipeline consistent with earlier weeks.

Keep focusing on integration and moving from individual classes to a complete playable loop. Once that is in place, it will become much easier to build and test win conditions and expand gameplay logic.