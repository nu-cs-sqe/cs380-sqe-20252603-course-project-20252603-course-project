...
| Test Case 6 | Attempt to modify the map via `getSupportedLocales().put(newLocale, key)` | Throws `UnsupportedOperationException` (guaranteeing immutability) | :white_check_mark: |