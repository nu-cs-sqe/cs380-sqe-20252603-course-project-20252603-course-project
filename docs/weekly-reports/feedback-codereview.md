...
## Week 7 Code Review
I have read every line of production code currently in the main branch and I don't find
any major violations of the coding standards required by letter grade A!
...
I have read every line of production code currently in the main branch and I don't find
any major violations of the coding standards required by letter grade A!
The only thing is the use of magic numbers in `GameSetupController` and `RiskApplication`.
Even for GUI code, it's still more readable if you create a constant for the value
