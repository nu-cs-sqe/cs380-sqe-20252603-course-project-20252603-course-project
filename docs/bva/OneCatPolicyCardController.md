...
- **TC4: Next player has exactly two of the same cat card (Boundary)** ( :white-check-mark: )
...
- **TC5: Next player has three of the same cat card (Boundary + 1)** ( :white-check-mark: )
